...
import { HeroVideoSchema, HeroTextSchema } from './modules/hero/hero.schema.ts';
import { NavSimpleSchema } from './modules/navbar/navbar.schema.ts';
import { FooterSimpleSchema } from './modules/footer/footer.schema.ts';
import { MenuGridSchema, MenuListSchema } from './modules/menu/menu.schema';
import { menuRegistry } from './modules/menu/menu.registry';
import { heroRegistry } from './modules/hero/hero.registry.ts';
import { navbarRegistry } from './modules/navbar/navbar.registry.ts';
import { footerRegistry } from './modules/footer/footer.registry.ts';
